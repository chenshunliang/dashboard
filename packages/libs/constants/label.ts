...
export const PAI_CONDA_CATALOG_KEY = `pai.kubegems.io/conda-catalog`;
export const PAI_WORKSPACE_CATALOG_KEY = `pai.kubegems.io/workspace-catalog`;
...
export const PAI_CONDA_FROM_KEY = `pai.kubegems.io/conda-from`;
