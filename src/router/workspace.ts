    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: `${prefix}/service_discovery`,
            name: 'app-discovery',
            component: () => import('@/views/resource/service_discovery/index.vue'),
            meta: {
              requireAuth: true,
              title: 'routerbar.cluster.app_service_discovery',
              icon: 'mdi-search-web',
              show: false,
              pluginOpenShow: true,
              rootName: 'workspace',
              tip: 'app_service_discovery',
              dependencies: ['nacos'],
              edge: false,
            },
          },
          {
            path: `${prefix}/service_discovery/:name`,
            name: 'app-discovery-detail',
            component: () => import('@/views/resource/service_discovery/detail.vue'),
            meta: {
              requireAuth: true,
              title: 'routerbar.cluster.app_service_discovery',
              icon: 'mdi-search-web',
