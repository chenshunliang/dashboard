    ...
    methods: {
      ...
      async ingressGatewayQPS() {
        const data = await this.m_permission_matrix(
          ...
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_QPS_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
      ...
      async ingressGatewayDownstream80QPS() {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_DOWNSTREAM_80_QPS_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
              .replaceAll('$2', this.gateway ? this.gateway.Name : '')
              .replaceAll('%', ''),
            noprocessing: true,
          }),
      ...
      async ingressGatewayDownstream443QPS() {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_DOWNSTREAM_443_QPS_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
              .replaceAll('$2', this.gateway ? this.gateway.Name : '')
              .replaceAll('%', ''),
            noprocessing: true,
          }),
      ...
      async ingressGatewayResponseDuration() {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_REPONSE_DURATION_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
              .replaceAll('$2', this.gateway ? this.gateway.Name : '')
              .replaceAll('%', ''),
            noprocessing: true,
          }),
      ...
      async ingressGatewayDownstream80ResponseDuration() {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_DOWNSTREAM_80_RESPONSE_DURATION_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
              .replaceAll('$2', this.gateway ? this.gateway.Name : '')
              .replaceAll('%', ''),
            noprocessing: true,
          }),
      ...
      async ingressGatewayDownstream443ResponseDuration() {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_GATEWAY_DOWNSTREAM_443_RESPONSE_DURATION_PROMQL.replaceAll('$1', SERVICE_GATEWAY_NS)
              .replaceAll('$2', this.gateway ? this.gateway.Name : '')
              .replaceAll('%', ''),
            noprocessing: true,
          }),
