  ...
  export default {
    ...
    methods: {
      ...
      async istioWorkloadRequestCount(noprocess = false) {
        const data = await this.m_permission_matrix(
          ...
          Object.assign(this.params, {
            query: ISTIO_WORKLOAD_QPS_PROMQL.replaceAll('$1', this.$route.params.name)
      ...
      async istioWorkloadRequestSumOverTime(noprocess = false) {
        const data = await this.m_permission_vector(this.$route.query.cluster, {
          query: ISTIO_WORKLOAD_REQUEST_LAST_24H_PROMQL.replaceAll('$1', this.$route.params.name)
            .replaceAll('$2', this.$route.query.namespace)
            .replaceAll('%', ''),
          noprocessing: noprocess,
        });
      ...
      async istioWorkloadResponseDurationSeconds(noprocess = false) {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_WORKLOAD_RESPONSE_DURATION_SECONDS_P95_PROMQL.replaceAll('$1', this.$route.params.name)
              .replaceAll('$2', this.$route.query.namespace)
              .replaceAll('%', ''),
            noprocessing: noprocess,
          }),
      ...
      async istioWorkloadResponseDurationSecondsP99(noprocess = false) {
        const data = await this.m_permission_vector(this.$route.query.cluster, {
          query: ISTIO_WORKLOAD_RESPONSE_DURATION_SECONDS_P99_PROMQL.replaceAll('$1', this.$route.params.name)
            .replaceAll('$2', this.$route.query.namespace)
            .replaceAll('%', ''),
          noprocessing: noprocess,
        });
      ...
      async istioWorkloadErrResponseCount(noprocess = false) {
        const data = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_WORKLOAD_ERR_QPS_PROMQL.replaceAll('$1', this.$route.params.name)
              .replaceAll('$2', this.$route.query.namespace)
              .replaceAll('%', ''),
            noprocessing: noprocess,
          }),
      ...
      async istioWorkloadErrResponseSumOverTime(noprocess = false) {
        const data = await this.m_permission_vector(this.$route.query.cluster, {
          query: ISTIO_WORKLOAD_ERR_REQUEST_LAST_24H_PROMQL.replaceAll('$1', this.$route.params.name)
            .replaceAll('$2', this.$route.query.namespace)
            .replaceAll('%', ''),
          noprocessing: noprocess,
        });
      ...
      async istioWorkloadNetwork(noprocess = false) {
        const data1 = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_INGRESS_NETWORK_PROMQL.replaceAll('$1', this.$route.params.name)
              .replaceAll('$2', this.$route.query.namespace)
              .replaceAll('%', ''),
            noprocessing: noprocess,
          }),
        ...
        const data2 = await this.m_permission_matrix(
          this.$route.query.cluster,
          Object.assign(this.params, {
            query: ISTIO_EGRESS_NETWORK_PROMQL.replaceAll('$1', this.$route.params.name)
              .replaceAll('$2', this.$route.query.namespace)
              .replaceAll('%', ''),
            noprocessing: noprocess,
          }),
