...
export const entryMicroService: RouteConfig[] = [
  {
    ...
    children: [
      // virtualspace
      {
        ...
        component: () => import('./virtualspace/index.vue'),
        meta: {
      ...
      // dnsdomain
      {
        path: 'dnsdomains',
        name: 'dnsdomain-list',
        component: () => import('./dnsdomain/index.vue'),
        meta: {
          icon: 'mdi-dns',
          requireAuth: true,
    ...
    children: [
      {
        ...
        component: () => import('./virtualspace/detail.vue'),
        meta: {
          requireAuth: true,
  ...
  },
  {
    ...
    children: [
      ...
      // microworkload
      {
        ...
        component: () => import('./workload/index.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./workload/detail.vue'),
        meta: {
          requireAuth: true,
          title: 'routerbar.microservice.workload',
          icon: 'mdi-vector-arrange-above',
      ...
      },
      {
        ...
        component: () => import('./service/detail.vue'),
        meta: {
          requireAuth: true,
          title: 'routerbar.microservice.service',
          icon: 'mdi-network',
  ...
  },
  {
    ...
    children: [
      // gateway
      {
        ...
        component: () => import('./istio_gateway/index.vue'),
        meta: {
          requireAuth: true,
      ...
      },
      {
        ...
        component: () => import('./istio_gateway/detail.vue'),
        meta: {
          requireAuth: true,
          title: 'routerbar.microservice.gateway_intance',
          icon: 'mdi-gate',
  ...
  },
  {
    ...
    children: [
      // authorizationpolicy
      {
        ...
        component: () => import('./istio/authorization_policy/index.vue'),
        meta: {
          requireAuth: true,
      ...
      // gateways
      {
        ...
        name: 'gateway-list',
        component: () => import('./istio/gateway/index.vue'),
        meta: {
          requireAuth: true,
      ...
      // peerauthentication
      {
        ...
        component: () => import('./istio/peer_authentication/index.vue'),
        meta: {
          requireAuth: true,
      ...
      // serviceentry
      {
        ...
        component: () => import('./istio/service_entry/index.vue'),
        meta: {
          requireAuth: true,
      ...
      // sidecar
      {
        ...
        name: 'sidecar-list',
        component: () => import('./istio/sidecar/index.vue'),
        meta: {
          requireAuth: true,
